...
class Cat(Base):
    ...
    rarity: Mapped[str] = mapped_column(String(16), nullable=False, default=CatRarity.COMMON.value)
    ...
    base_meow_interval_sec: Mapped[int] = mapped_column(Integer, nullable=False, default=600)  # 10 min
